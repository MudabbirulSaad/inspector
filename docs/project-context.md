...
The repository currently contains governance documentation, JSON Schemas, examples, and schema/example validation tests. Runtime CLI implementation, TypeScript source, and build tooling are still pending.
