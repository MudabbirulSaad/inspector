...
const agentContracts = [
  ...
  },
  {
    ...
    description:
      "Identifies evidence-backed strong and weak architecture decisions, engineering risks, assumptions, safety risks, and adaptation warnings.",
    lifecycle: "v1",
    dependencies: ["architecture", "pattern_miner", "testing_strategy"],
    outputArtifacts: ["agents/tradeoff_analyst/attempt-{attempt}/output.json"],
